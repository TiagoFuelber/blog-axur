...
import makeGetPublications from './getPublications';
...
describe('getPublications function', () => {
  it('should return a list of publications', async () => {
    ...
    const mockedRepository = {
      getPublications: () =>
        Promise.resolve(publicationList)
    };

    const getPublications = makeGetPublications({ repository: mockedRepository });

    getPublications({
      onSuccess: publications =>
        expect(publications).to.be.eql(
